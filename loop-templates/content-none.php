...
<section class="no-results not-found">
	...
	<header class="page-header">
		...
		<h1 class="page-title h4"><?php esc_html_e( 'Nothing Found', 'understrap' ); ?></h1>
	...
	'a' => array(
		...
		<?php elseif ( is_search() ) : ?>
			...
			<p class = "mb-3"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'understrap' ); ?></p>
			<?php
				get_search_form();
		else : ?>
